...
cpldfit.exe -intstyle ise -p xc95144xl-10-TQ100 -ofmt vhdl -htmlrpt -exhaust -optimize density -loc on -slew fast -init low -inputs 50 -pterms 35 -unused float -power std -terminate float control.ngd >log.txt 
