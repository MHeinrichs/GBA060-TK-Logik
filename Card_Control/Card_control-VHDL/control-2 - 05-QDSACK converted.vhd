...
architecture control_behav of control is
   signal CAQ0_CLK_ctrl,
	 ...
	 LDSACK0_ACLR, STOPHALT, STOPRES, BYTEPORT, WORDPORT, LONGPORT, AMISEL, NAMIACC,
	 ATERM, LEND, CAQ0, CAQ1, CAQ2, CNTDIS, LDSACK1,
	 LDSACK0, AMIQ1, AMIQ0, RSTINT: std_logic;
   signal 
	 LE_BS_FB, DS30_FB, AMIQ0_FB, AMIQ1_FB,
	 LDSACK0_FB, LDSACK1_FB, CNTDIS_FB, CAQ2_FB,
...
-- Start of original equations
   ...
   LDSACK0_D <= ((not DSACK30(0)) and (QDSACK(0) or QDSACK(1))) or ((not STERM30)
	 and (QDSACK(0) or QDSACK(1))) or (LDSACK0 and AMIQ1 and AMIQ0 and (not
	 CNTDIS));
   LDSACK1_ACLR <= NAMIACC;
   LDSACK1_CLK <= not SCLK_SIG;
   LDSACK1_D <= ((not DSACK30(1)) and (QDSACK(0) or QDSACK(1))) or ((not STERM30)
	 and (QDSACK(0) or QDSACK(1))) or (LDSACK1 and AMIQ1 and AMIQ0 and (not
	 CNTDIS));
   OE_BS <= AMISEL;
   DIR_BS <= RW40;
