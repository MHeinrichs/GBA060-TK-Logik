...
--	    TEA40, BGR60, ICACHE: buffer std_logic
 Port ( SEL16M : in  STD_LOGIC;								--Steuerwort vom Ram-Controller	SEL16M		
           ...
           SCLK : inout  STD_LOGIC;								--BCLK zum Ram-Controller
           CLK_BS : out  STD_LOGIC;								--CLK Bus-Sizing
           CLK_RAMC : inout  STD_LOGIC;							--CLK RAM-Controller
           ...
           RSTI40 : inout  STD_LOGIC;								--Reset-Eingang zur 040-CPU
...
architecture control_behav of control is
   signal H0_CLK_ctrl, H0_ACLR_ctrl, F0_CLK_ctrl, F0_ACLR_ctrl, CAQ0_CLK_ctrl,
	 ...
	 RESET30_OE, RSTI40_D, RSTI40_CLK, 
	 BCLK_CLK,   
	 PLL_S0_OE, PLL_S1_OE, STOPHALT, STOPRES, F0,
...
-- Tristate Section
   ...
   PLL_S(1) <= PLL_S1_ZD when PLL_S1_OE='1' else 'Z';
   PLL_S(0) <= PLL_S0_ZD when PLL_S0_OE='1' else 'Z';
...
-- Register Section
   ...
   process (PLL_CLK) begin
	 ...
	 CLK30_FB <= CLK30_FB xor not CLK_RAMC_FB;
	 PCLK_FB <= not CLK_RAMC_FB;
	 SCLK_FB <= CLK30 xor CLK_RAMC_FB;
	 CLK_BS_FB <= not CLK_RAMC_FB;
	 CLK_RAMC_FB <= not CLK_RAMC_FB;
      end if;
   end process;
...
-- Start of original equations
   ...
   BYTEPORT <= (RSTI40 and (not LDSACK1) and LDSACK0) or (BYTEPORT and (not
	 ((not CAQ2) and (not CAQ1) and (not CAQ0))));
   TA40_OE <= AMISEL;
   AMISEL <= (RSTI40 and (not TT40(1)) and SEL16M) or (RSTI40 and TT40(1));
   TBI40 <= not ((RSTI40 and (not TT40(1)) and SEL16M) or (RSTI40 and TT40(1)));
   ...
   begin
	 ...
	 if (RSTI40 and ATERM and (not LDSACK1) and LDSACK0 and (not CNTDIS)
	    ...
	    (CAQ2_D, CAQ1_D, CAQ0_D) <= std_logic_vector'("011");
	       ...
	       SIZ40(0)))) or (RSTI40 and ATERM and (not LDSACK1) and LDSACK0
