...
-- Register Section
   ...
   process (CLK_RAMC, RESET) begin
      if RESET='0' then
			...
			if(SIZ40 = "11" and CQ = read_start_ras)then
				burst <="11";
			elsif(SIZ40 = "11" and CQ = write_start_ras)then
				burst <="10"; --one less because we end one cycle earlier
			elsif(ENACLK_PRE ='0')then
